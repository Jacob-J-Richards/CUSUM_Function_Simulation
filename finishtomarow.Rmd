...
```{r}
CUSUM_Chart <- function(user_data,user_mu_naught) {
...
object <- new("CUSUM", upper_signal=upper_signal, lower_signal=lower_signal, 
  CL= spc::xcusum.crit(k = .5, L0 = 370.0, mu0 = user_mu_naught, hs = 0, sided = "two",r = 30), time=time, input = user_data ,Reject_H0 = Reject_H0)
