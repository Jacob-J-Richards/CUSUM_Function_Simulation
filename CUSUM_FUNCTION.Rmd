...
```{r}
CUSUM_Chart <- function(user_data,user_mu_naught,user_k) {
...
object <- new("CUSUM", upper_signal=upper_signal, lower_signal=lower_signal, 
  CL= spc::xcusum.crit(k = user_k, L0 = 370.0, mu0 = user_mu_naught, hs = 0, sided = "two",r = 30), time=time, input = data_4 ,Reject_H0 = Reject_H0)
